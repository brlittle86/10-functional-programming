'use strict';
// REVIEW: Check out our new arrow function syntax!!
...
const app = express();
const conString = 'postgres://postgres:B86j07L13@localhost:5432/postgres'; // DONE: Don't forget to set your own conString
